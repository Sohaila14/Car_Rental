...
//show category
include_once("admin/includes/categoryShow.php"); 
?>
<!doctype html>
<html lang="en">
                      ...
                      <div class="card-content">
                        <div class="card-body">
                          <div class="media d-flex">
                            ...
                            <?php } else {echo '<div class="alert alert-success">No car selected to be displayed </div>';}?>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                <h3>Categories</h3>
                <?php foreach($stmtCat->fetchAll() as $row){
